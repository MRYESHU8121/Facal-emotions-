# -*- coding: utf-8 -*-
"""
Created on Thu Feb 23 11:50:25 2023
...
face_cascade = cv2.CascadeClassifier('E:/arificial classs/Day 5/haarcascade_frontalface_alt.xml')
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        gender_text = "Gender: " + gender['gender']
        print(emotion_text)
        print(gender_text)
